========================================================================
    KONSOLENANWENDUNG: MPI_Clean-Projektübersicht
========================================================================

Diese MPI_Clean-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MPI_Clean-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MPI_Clean.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
